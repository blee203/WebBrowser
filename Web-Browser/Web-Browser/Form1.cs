    ...
    public partial class Bee : Form
    {
        ...
        private void toolStripButton5_Click(object sender, EventArgs e)//nút tìm kiếm
        {
            ...
            if (searchText.Contains("www.")||searchText.Contains("http"))
                ...
                webB.Navigate(searchEngineDefault + searchText);
        ...
        private void WebB_DocumentCompleted1(object sender, WebBrowserDocumentCompletedEventArgs e)//cập nhật tên tab
        {
            ...
            searchBox.Text = webB.Url.ToString();

            tabControl1.SelectedTab.AccessibleDescription = searchBox.Text;
            if (isBookmarked(webB.Url.ToString())) bookmarkButton.Image = ((System.Drawing.Image)(resources.GetObject("alreadyBookmarkButton.Image")));
        ...
        {
            if (webB.Url == null) return;
            bool bookmarked = isBookmarked(webB.Url.ToString());
            if (!bookmarked)
            {
                ...
                deleteLineOfFile(webB.DocumentTitle, "BM_Name.txt");
                deleteLineOfFile(webB.Url.ToString(), "BM_URL.txt");
            }
            updateBM();
        }
        ...
        private void addBookmarkButton_Click(object sender, EventArgs e)//add bookmark
        {
        ...
        private void editBookmarkButton_Click(object sender, EventArgs e)//edit bookmark
        {
        ...
        void addThisBookmark()//bookmark current tab
        {
            ...
            {
                sw.WriteLine(webB.DocumentTitle);
            }
            using (StreamWriter sw = File.AppendText("BM_URL.txt"))
            {
                sw.WriteLine(webB.Url.ToString());
            }
        }
